...
// import { webStyles } from './styles/SearchOptionsComponent.web.styles'; // Not needed for mobile
...
const MobileSearchOptionsComponent: React.FC<Props> = ({ searchOptions, setSearchOptions, locationError }) => {
  const platformStyles = mobileStyles; // Always use mobile styles for this component
  return (
